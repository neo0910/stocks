...
export const TICKERS_SEARCH_TOPIC = 'tickers.search';
export const TICKERS_SEARCH_REPLY_TOPIC = 'tickers.search.reply';
export const PRICE_DAILY_TOPIC = 'price.daily';
